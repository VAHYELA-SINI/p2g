...
export default function ProductEdit() {
  ...
  useEffect(() => {
    async function loadInitialData() {
      try {
        ...
        setErrorMessage(err.message || 'Unable to load product information.');
      } finally {
        setIsLoading(false);
      }
    }
  ...
  if (isLoading) {
    return <LoadingState message="Loading product details..." minHeight="min-h-[400px]" />;
  }
    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-xs">
        ...
        <p className="text-sm text-slate-500 mb-8">
          Update pricing, stock availability, category assignment, and media.
        </p>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-5 items-start">
              ...
              <div className="flex-1 space-y-3 w-full">
                ...
                <div className="text-xs text-slate-400">Or update direct image URL:</div>
                <input
                  type="url"
